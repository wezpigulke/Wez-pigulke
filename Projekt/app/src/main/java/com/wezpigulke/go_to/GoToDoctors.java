        ...
        if (c.getCount() != 0) {
            while (c.moveToNext()) {
                if(c.getString(3).equals("0")) {
                    results.add(new Doctor(c.getInt(0), c.getString(1), c.getString(2), "", c.getString(4), c.getInt(5)));
                } else results.add(new Doctor(c.getInt(0), c.getString(1), c.getString(2), c.getString(3), c.getString(4), c.getInt(5)));
            }
        }
