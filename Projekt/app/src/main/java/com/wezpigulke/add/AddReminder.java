            ...
            if ((iloscTabletek - jakaDawkaTabletki) >= 0) {
                ...
                if (coWybrane == 0) {
                    ...
                    if (diffDays == 0 && diffInMillis < 0) {
                        ...
                        intx.putExtra("czyPowtarzanyAlarm", false);
                        intx.putExtra("tresc", uzytkownik + " |  " + godzinaTabletka.getText().toString() + "  |  już czas, aby wziąć: " + nazwaLeku + " (Dawka: " + jakaDawka + ")");
                        intx.putExtra("id", id);
                    ...
                    if(ileDni.getText().length() > 0) {
                        ...
                        for (Integer i = 1; i <= ileRazyDziennie; i++) {
                            ...
                            if (czyUsunacDzien != 1 && iloscDni>=1) {
                                ...
                                intx.putExtra("tresc", uzytkownik + " |  " + godzinaPrzypomnienia + "  |  już czas, aby wziąć: " + nazwaLeku + " (Dawka: " + jakaDawka + ")");
                                intx.putExtra("coPokazac", 0);
                                intx.putExtra("czyPowtarzanyAlarm", true);
                                intx.putExtra("id", id);
                                intx.putExtra("idd", idd);
